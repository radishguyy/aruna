      ...
      <div className="p-6 md:p-12 space-y-8 font-sans max-w-xl mx-auto h-full">
        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 leading-tight">{userName}</h3>
              <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mt-1">{user?.role || 'parent'}</p>
            </div>
          </div>
