  ...
  return (
    <TeacherLayout>
      ...
      <div className="p-6 md:p-12 space-y-8 font-sans max-w-xl mx-auto h-full">
        <div>
          <h1 className="text-3xl font-black text-gray-900 mb-2 tracking-tight">Profil Pengajar</h1>
          <p className="text-gray-500 font-medium">Informasi akun pengajar Anda di Aruna.</p>
        </div>
          ...
          <div className="border-t border-gray-50 pt-6 space-y-4">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-600">
              ...
              <div>
                ...
                <div className="font-bold text-gray-800">Guru / Pengajar</div>
              </div>
            </div>
          </div>
        </div>
