    ...
    <TeacherLayout>
      ...
      <div className="p-6 md:p-12 space-y-8 font-sans max-w-xl mx-auto h-full">
        <div className="text-center">
          ...
          <p className="text-gray-500 font-medium">Pantau status berlangganan dan aktivasi lisensi sekolah Anda.</p>
        </div>

        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm space-y-6">
          <div className="flex justify-between items-center pb-4 border-b border-gray-50">
            <span className="font-bold text-gray-800">Status Langganan</span>
            <span className="bg-emerald-50 text-emerald-600 font-black px-4 py-1.5 rounded-full text-xs uppercase border border-emerald-100">Aktif</span>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            ...
            <div className="flex-1">
              ...
              <div className="font-bold text-gray-800">Hingga 12 Juli 2027</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            ...
            <div className="flex-1">
              ...
              <div className="font-bold text-gray-800 font-mono">ARUNA-SCH-2026-X8A9L</div>
            </div>
            <button className="text-teal-600 hover:text-teal-700 bg-teal-50 px-3 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1">
