...
const teamShortNames: Record<string, string> = {
  'Ahmad Fachri Nurfauzan': 'Fachri',
  'Muhamad Nur Iman': 'Iman',
  'Vina Alviaturohmah': 'Vina',
  'Mufti Mumtaz Maulana': 'Mufti',
  'Afrah Suci Ramadhani': 'Afrah'
};
...
export default function AboutPage() {
  ...
  return (
    <div className="font-sans text-slate-800 bg-[#FAFCFF] min-h-screen selection:bg-orange-200 pb-24 overflow-x-hidden">

      {/* ================= 1. HERO SECTION ================= */}
      <section className="pt-32 pb-16 px-4 md:px-6 max-w-[1200px] mx-auto">
