                  ...
                  <>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input id="userName" name="userName" autoComplete="off" type="text" required placeholder="Masukkan nama Anda" className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-[1.2rem] text-[15px] focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all text-gray-900" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input id="userEmail" name="userEmail" autoComplete="off" type="email" required placeholder="alamat@email.com" className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-[1.2rem] text-[15px] focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all text-gray-900" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input id="userPassword" name="userPassword" autoComplete="off" type="password" required placeholder="Buat kata sandi" className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-[1.2rem] text-[15px] focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all text-gray-900" />
                      </div>
                    </div>
                  </>
                ) : (
                  <>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input id="instName" name="instName" autoComplete="off" type="text" required placeholder="TK Tunas Bangsa" className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-[1.2rem] text-[15px] focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all text-gray-900" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"><Mail className="h-5 w-5 text-gray-400" /></div>
                        <input id="instEmail" name="instEmail" autoComplete="off" type="email" required placeholder="info@sekolah.edu" className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-[1.2rem] text-[15px] focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all text-gray-900" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input id="instLicense" name="instLicense" autoComplete="off" type="text" placeholder="XXXX-XXXX-XXXX" className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-[1.2rem] text-[15px] focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all text-gray-900" />
                      </div>
                    </div>
                  </>
                )}
