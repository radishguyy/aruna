              ...
              <form onSubmit={handleFinish} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input id="childName" name="childName" autoComplete="off" type="text" required placeholder="Cth: Fachri" className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-[1.2rem] text-[15px] focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                  </div>
                </div>
